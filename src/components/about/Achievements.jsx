            ...
            <Container className="relative z-10">
                <div className="mb-20">
                    <motion.span
                        ...
                        viewport={{ once: true }}
                        className="px-4 py-1.5 rounded-full text-[10px] font-black tracking-[0.3em] uppercase bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 mb-6 inline-block shadow-[0_0_20px_rgba(16,185,129,0.1)]"
                    >
                        Success Stories
                    </motion.span>
